-- models/intermediate/int_medical_group_plan_action_summary_monthly.sql

{{
    config(
        materialized='ephemeral',
        indexes=[
            {'columns': ['medical_group_id', 'plan_id', 'date_month'], 'unique': True},
            {'columns': ['date_month']},
...
FROM final
ORDER BY medical_group_id, plan_id, date_month